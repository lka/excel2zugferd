...
class test_zugFerd(unittest.TestCase):
    ...
    def test_add_xml2pdf(self):
        ...
        self.zugferd.add_rechnungsempfaenger('Musterfrauen GmbH & CoKG\nAnette Musterfrau\nAm Bild 19\n98766 Unterschleißheim')
        self.zugferd.add_zahlungsempfaenger(
            "Max Mustermann\nIBAN: DE97 xxx xxx xxx xxx xxx xxx\nBIC: SOLADES1XYZ"
        )
        self.zugferd.add_myCompany('Max Mustermann\nMusterstr. 1\n12345 Musterstadt', 'Max Mustermann - Softwareentwicklung', 'Tel.: 01234-123456789\nEmail: max@mustermann.de', '12345/6789')
        ...
        self.zugferd.add_zahlungsziel("Zahlbar ohne Abschlag bis", datetime.now()+ timedelta(days=int(14)))
